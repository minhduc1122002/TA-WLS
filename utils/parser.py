...
parser.add_argument('--missing_mode', type=str, default='random', choices=['random','left_leg', 'right_leg', 'left_hand', 'right_hand'], help="Choose which part is missing")
...
parser.add_argument('--total_joint', type=int, default=25, help="Number of total input joints")
